...
let favoriteFoods = ['Steak', 'Eggs', 'Sausage', 'Brussel Sprouts', 'Mushrooms', 'Chips & Dip'];
...
console.log('Changed second food', favoriteFoods);
...
console.log('Foods are now in reverse alphabetical order', favoriteFoods);

// 4.g (STRETCH) TODO: Convert your array to a string
//     putting the word "and" between each item.
//     eg "tacos and pizza and pasta". Log the string.

let foodString = favoriteFoods[0] + ' and ' + favoriteFoods[1] + ' and ' + favoriteFoods[2] + ' and ' + favoriteFoods[3] + ' and ' + favoriteFoods[4] + ' and ' + favoriteFoods[5] + '!';
console.log('I want to eat', foodString);
